(function() {
  var Access, Arr, Assign, Base, Block, Call, Class, Closure, Code, Comment, Existence, Extends, For, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, Load, METHOD_DEF, NEGATE, NO, Obj, Op, Param, Parens, RESERVED, Range, Return, SIMPLENUM, Scope, Slice, Splat, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, While, YES, compact, del, ends, extend, flatten, last, merge, multident, starts, unfoldSoak, utility, _ref,
  ...
  exports.Load = Load = (function(_super) {
    ...
    Load.prototype.children = ['expression'];

    Load.prototype.isStatement = YES;

    Load.prototype.rootDir = '../../';

    Load.prototype.compileNode = function(o) {
      var code, module, path, qualifiedModule, service;
      code = this.expression.compile(o);
      qualifiedModule = eval(code).split('.');
      module = qualifiedModule[0];
      service = qualifiedModule[1];
      path = "" + this.rootDir + "domain/" + module + "/" + service;
