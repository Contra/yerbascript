(function() {
  var Access, Arr, Assign, Base, Block, Call, Class, Closure, Code, Comment, Existence, Extends, For, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, Macro, NEGATE, NO, Obj, Op, Param, Parens, RESERVED, Range, Return, SIMPLENUM, Scope, Slice, Splat, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, While, YES, classDef, compact, def, del, ends, extend, flatten, last, macros, merge, multident, name, projectRoot, starts, unfoldSoak, utility, _ref, _ref2,
  ...
  _ref = require('./extensions'), projectRoot = _ref.projectRoot, macros = _ref.macros;
  ...
  exports.Literal = Literal = (function(_super) {
    ...
    Literal.prototype.compileNode = function(o) {
      var code, _ref3, _ref4;
      code = this.isUndefined ? o.level >= LEVEL_ACCESS ? '(void 0)' : 'void 0' : this.value === 'this' ? ((_ref3 = o.scope.method) != null ? _ref3.bound : void 0) ? o.scope.method.context : this.value : this.value.reserved && ((_ref4 = "" + this.value) !== 'eval' && _ref4 !== 'arguments') ? "\"" + this.value + "\"" : this.value;
      if (this.isStatement()) {
  ...
  exports.Assign = Assign = (function(_super) {
    ...
    Assign.prototype.compilePatternMatch = function(o) {
      ...
      if (top && olen === 1 && !((obj = objects[0]) instanceof Splat)) {
        ...
        if (_ref6 = obj.unwrap().value, __indexOf.call(['arguments', 'eval'].concat(RESERVED), _ref6) >= 0) {
  ...
  exports.Code = Code = (function(_super) {
    ...
    Code.prototype.compileNode = function(o) {
      var code, exprs, i, idt, lit, p, param, ref, splats, v, val, vars, wasEmpty, _i, _j, _k, _l, _len, _len2, _len3, _len4, _ref3, _ref4, _ref5, _ref6, _ref7;
      ...
      if (this.bound) {
        if ((_ref7 = o.scope.parent.method) != null ? _ref7.bound : void 0) {
  ...
  exports.Macro = Macro = (function(_super) {
    ...
    Macro.prototype.compileNode = function(o) {
      var className, compileNodeFunction, name, toCamel, tokenName;
      if (this.args.length !== 2) throw SyntaxError('macro takes two arguments');
      toCamel = function(str) {
        return str.replace(/^[a-z]/g, function(firstChar) {
          return firstChar.toUpperCase();
        });
      };
      name = eval(this.args[0].compile(o));
      className = toCamel(name);
      tokenName = name.toUpperCase();
      compileNodeFunction = this.args[1].compile(o);
